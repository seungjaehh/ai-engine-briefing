...
설정 파일은 UTF-8입니다. 엔진 폴더와 브리핑 폴더는 서로 포함 관계일 수 없습니다. 수집 대상은 Markdown과 코드 파일이며 `research/scratch`, `.git`, 의존성·빌드·캐시 폴더 및 심볼릭 링크는 제외합니다. 큰 파일 또는 수집 실패가 있으면 마지막 정상 브리핑을 보존합니다.
